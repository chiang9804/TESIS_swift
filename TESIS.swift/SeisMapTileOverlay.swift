//
//  SeisMapTileOverlay.swift
//  TESIS.swift
//
//  Created by IES on 4/9/15.
...
class SeisMapTileOverlay: MKTileOverlay{
    ...
    override func URLForTilePath(path: MKTileOverlayPath) -> NSURL! {
        ...
        return NSURL(string: "http://tesis.earth.sinica.edu.tw/testimage/seisMapTiles35_0_50/\(path.x)-\(path.y)-\(path.z).png")
    }
